...
// =============================================
const DASHBOARD_VERSION = "2026-04-24-T1115 (v1407)";
...
async function showPage(id) {
  ...
  if (mainEl) {
    ...
    console.log(`🏠 [NAV] #main state: visibility=${mainStyle.visibility}, opacity=${mainStyle.opacity}, display=${mainStyle.display}, height=${mainEl.offsetHeight}px`);
  }
  ...
  if (isIndustrial) {
    console.log(`💎 [NAV] Found industrial content. Switching to topic_viewer.`);
    page = document.getElementById('topic_viewer');
  } else if (!page && topicConfig[id]) {
    // 2. Fallback to AI Generator
    console.log(`🤖 [NAV] No content. Switching to AI Generator fallback.`);
    page = document.getElementById('topic_viewer');
