// Version: 2026-04-21-T1420 (Imperial Data Mode)
// =============================================
console.log('%c Dashboard Version: 2026-04-21-T1420 (v1367)', 'color: #10b981; font-weight: bold; font-size: 14px;');
...
function renderProfileMatchPage(profile) {
  ...
  if (missing.length > 0) {
    html += '<div style="margin-bottom:20px;"><div style="font-weight:700;font-size:0.9rem;color:var(--text);margin-bottom:10px; display:flex; align-items:center; gap:8px;">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" style="width:14px;height:14px;color:var(--amber);"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>' +
  ...
  if (topics.length > 0) {
    html += '<div style="margin-bottom:20px;"><div style="font-weight:700;font-size:0.9rem;color:var(--text);margin-bottom:10px; display:flex; align-items:center; gap:8px;">' +
      '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="width:16px;height:16px;color:var(--blue);"><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z"></path><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z"></path></svg>' +
      'AI Recommended Study Topics</div>';
    html += '<div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(280px,1fr));gap:12px;">';
    topics.forEach(function(t) {
      var topicName = t.topic || t.name || t.id || 'Specialized Topic';
      ...
      var topicId = t.topicId || topicName.toLowerCase().replace(/\s+/g, '_');
