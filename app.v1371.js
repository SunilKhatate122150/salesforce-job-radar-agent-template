// Version: 2026-04-21-T1500 (Ironclad Universal Mode)
// =============================================
console.log('%c Dashboard Version: 2026-04-21-T1500 (v1371)', 'color: #10b981; font-weight: bold; font-size: 14px;');
...
function renderProfileMatchPage(profile) {
  ...
  if (topics.length > 0) {
    ...
    topics.forEach(function(t) {
      var rawName = t.topic || t.name || t.id || t.title || t.label || t.subject || t.topicName || t.key || t.header || t.content || '';
      var topicName = (typeof rawName === 'string' ? rawName.trim() : 'Specialized Topic') || 'Career Specialization';
