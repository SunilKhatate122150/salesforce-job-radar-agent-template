// Version: 2026-04-21-T1450 (Universal Fluid Mode)
// =============================================
console.log('%c Dashboard Version: 2026-04-21-T1450 (v1370)', 'color: #10b981; font-weight: bold; font-size: 14px;');
...
function renderProfileMatchPage(profile) {
  ...
  if (topics.length > 0) {
    ...
    topics.forEach(function(t) {
      var rawName = t.topic || t.name || t.id || t.title || t.label || t.subject || t.topicName || t.key || t.header || '';
      var topicName = (typeof rawName === 'string' ? rawName.trim() : 'Specialized Topic') || 'Career Growth Topic';
