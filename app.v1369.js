// Version: 2026-04-21-T1440 (Responsive Layout Mode)
// =============================================
console.log('%c Dashboard Version: 2026-04-21-T1440 (v1369)', 'color: #10b981; font-weight: bold; font-size: 14px;');
...
function renderProfileMatchPage(profile) {
  ...
  html += `
    <div class="profile-grid">
      <div style="display:flex; align-items:center; gap:15px; background:rgba(255,255,255,0.02); border:1px solid rgba(255,255,255,0.08); border-radius:16px; padding:20px; min-width:0;">
